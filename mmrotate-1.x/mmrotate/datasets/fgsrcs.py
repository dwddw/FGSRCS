...
class FGSRCSlv0Dataset(BaseDataset):
    """FGSRCS-level0 dataset for detection.
...
@DATASETS.register_module()
class FGSRCSlv1Dataset(FGSRCSlv0Dataset):
    """
    FGSRCS-level1 dataset for detection.
    """
...
@DATASETS.register_module()
class FGSRCSlv2Dataset(FGSRCSlv0Dataset):
    """
    FGSRCS-level2 dataset for detection.
    """

    METAINFO = {
        'classes':
        ('aircraft-carrier', 'amphibious-assault-ship', 'amphibious-transport-dock',
         'corvette', 'cruiser', 'destroyer', 'frigate', 'landing-ship','littoral-combat-ship',
         'mine-warfare-vessel', 'patrol-vessel', 'replenishment-oiler', 'submarine',
         'container-ship', 'cruise-ship', 'oil-tanker', 'sand-carrier'),
        # palette is a list of color tuples, which is used for visualization.
...
@DATASETS.register_module()
class FGSRCSDataset(FGSRCSlv0Dataset):
    """
    FGSRCS-level2 dataset for detection.
    """
